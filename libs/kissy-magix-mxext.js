...
var Router=MIX({
    ...
    route:function(){
        ...
        var oldLocation=me.$lLoc||{params:{}};
        ...
        if(path&&Magix.isString(path)){
            ...
            if(!me.compareLocation(pathObj,me.$tLoc)){
                ...
                if(me.supportState()){//如果使用pushState
                    ...
                    me.fire('locationChanged',{loc:loc,slient:true});
        ...
        if(viewPath){
            ...
            var callback=function(View){
                ...
                view.on('interact',function(e){//view准备好后触发
                    me.fire(ViewLoad,{view:view},me.vced=true);
                    /*
 ...
 *   }
 */
var WrapAsynUpdateNames={render:1,renderUI:1,updateUI:1};
var WrapKey='~~';
...
Magix.mix(VProto,{
    ...
    load:function(){
        ...
        var ready=function(){
             ...
             */
            me.fire('interact',{tmpl:hasTemplate},true);//可交互
